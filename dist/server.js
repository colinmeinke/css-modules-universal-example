...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hello = __webpack_require__(151);
	...
	app.get('/', function (req, res) {
	  res.send('<!DOCTYPE html>\n     <html style="height: 100%">\n       <head>\n         <title>CSS modules example</title>\n         <link rel="stylesheet" href="/styles.css">\n       </head>\n       <body style="height: 100%; margin: 0">\n         <div\n           class="app"\n           style="height: 100%"\n         >' + (0, _server.renderToString)(_react2.default.createElement(_Hello2.default, null)) + '</div>\n       </body>\n       <script defer src="/client.js" /></script>\n     </html>');
	});

	app.get('/client.js', function (req, res) {
	  res.sendFile(_path2.default.join(__dirname, '..', 'dist', 'client.js'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _styles = __webpack_require__(152);
